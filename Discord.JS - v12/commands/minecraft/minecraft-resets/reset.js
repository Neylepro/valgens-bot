...
module.exports = {
    ...
    async execute(message, _args, client) {
        ...
        embednoip.setDescription(`• No IP has been setuped , For Setup Use **.setup**`)
        ...
        embednoport.setDescription(`• No PORT has been setuped , For Setup Use **.setup**`)
        ...
        embedReset.setURL("https://bot-mss.tk")
